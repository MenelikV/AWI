const URL = "http://localhost:1337/Settings/ANEMO"
describe("Settings change should not break the app", function(){
    ...
    afterEach(function(){
        ...
        cy.visit("http://localhost:1337/Activities/ANEMO/flights")
        cy.visit(URL)      
    })
    after(function(){
        // Back to normal
        cy.visit(URL)
        cy.get('#csv_dir').clear().type("assets/test_files/anemo/csv/")
